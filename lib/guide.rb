...
class Guide
    ...
    # locate restaurant text file that's in that path
    Restaurant.filepath = path
    if Restaurant.file_usable?
        puts "Found resautrant file."
    ...
    def introduction 
        puts "\n\n || Welcome to Your Food Guide! || \n\n"
        puts "This is an interactive guide to help you figure out what to eat.\n\n"
    end
